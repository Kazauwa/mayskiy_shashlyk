...
def store_firestart_polygon(fire_polygon, db_session):
    ...
    db_session.commit()
    fake_fire_spot1_relationship = models.SpotM2MPolygon(
        polygon_id=firestart_polygon.id,
        spot_id=fake_fire_spot1.id
    )
    fake_fire_spot2_relationship = models.SpotM2MPolygon(
        polygon_id=firestart_polygon.id,
        spot_id=fake_fire_spot1.id
    )
    fake_fire_spot3_relationship = models.SpotM2MPolygon(
        polygon_id=firestart_polygon.id,
        spot_id=fake_fire_spot1.id
    )
    db_session.add_all(
